...
O dataset também possui features categóricas, que apresentam valores discretos. Para elas montamos gráficos com a quantidade de itens por cada valor possíveis para a feature. A análise da feature de histórico familiar indica que a quantidade de pessoas com valor positivo e negativo é quase igual. A de pressão arterial possui três possíveis valores: Hipertensão, Normal e Pre-hipertensão. Para esses três possíveis valores temos quantidades distintas de amostras, mas essa diferença observada não chega preocupar em termos do impacto na qualidade do treinamento do modelo. Porém isso não pode ser afirmar para as outras duas features categóricas do data set, o nível de exercício e fumante. A primeira apresenta um moderado grau de desbalanceamento, temos mais de 600 indivíduo com baixo nível de exercício, por volta de 270 com alto (menos da metado da quantidade de alto) e algo am torno de 430 com moderado. Provavelmente para essas ultimas duas feaures teremos que aplicar técnicas para balancear a quantidade de amostras entre os possíveis valores discretos. 
(FALAR QUAL TÉCNICA DE BALANCEAMENTO APLICAMOS)
