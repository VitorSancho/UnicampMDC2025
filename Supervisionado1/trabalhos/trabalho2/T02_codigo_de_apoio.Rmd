...
# reordenar: todas as colunas menos a escolhida, depois a escolhida
...
# Treinamento    
model <- glmnet(train_data[,1:18], train_data$Risco.Hipertensao, family = "binomial", standardize=FALSE, maxit=1e+05, alpha=0, lambda=1e-6)
print(model$beta)
print(model$a0)
