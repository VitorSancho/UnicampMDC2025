...
Levando isso em consideração, no conjunto de treinamento tivemos certa de 77% de recall. O percentual caiu para 68% na validação, não ocorrendo então um overfitting  no modelo. A precisão ficou em torno de 55%, mas não vamos nos precupar com essa métrica, pois ela penaliza a presença de falsos positivos - e como dito anteriormente, não temos que temer dizer que uma pessoa tem risco quando na verdade não tem.
<!-- Fim da resposta -->
