...
Apesar de, em termos absolutos, um resultado de Acurácia Balanceada 84% na validação parecer bom, ao comparar com o conjunto de treinamento, e considerando também a profundidade e quantidade de nós no modelo baseline2, tudo indica que estamos num cenário de overfitting, e a performance no mundo real poderia ser bem menor. 
