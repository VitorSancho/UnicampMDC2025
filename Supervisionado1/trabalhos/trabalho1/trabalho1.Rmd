...
```{r}
dados_para_encoding <- dados_treino_sem_NAs
idade_one_hot_encoding <- model.matrix(~dados_para_encoding$Idade - 1, data = dados_para_encoding)
dados_para_encoding <- cbind(dados_para_encoding, idade_one_hot_encoding)

genero_one_hot_encoding <- model.matrix(~dados_para_encoding$Genero - 1, data = dados_para_encoding)
dados_para_encoding <- cbind(dados_para_encoding, genero_one_hot_encoding)

dados_para_encoding$Idade <- NULL
dados_para_encoding$Genero <- NULL

head(dados_para_encoding, 20)
```
