...
paste("Summary após a remoção de registros com NA:")
summary(dados_treino_sem_NAs)

NAs_removidos_treino <- nrow(dados_treino) - nrow(dados_treino_sem_NAs)
paste("Foram removidos",NAs_removidos_treino," registros inválidos", sep=" ")

paste("Versão final após limpeza dos dados possui",
      nrow(dados_treino_sem_NAs),"registros",sep=" ")
...
paste("Versão final após limpeza dos dados possui",
      nrow(dados_validacao_sem_NAs),"registros",sep=" ")
...
Para abordar a alta correlação entre Peso e Altura e simplificar o modelo, iremos transformar as features Peso e Altura em uma, calculando o IMC, conforme a fórmula: IMC = Peso/Altura^2
...
treino_engineered$IMC <- IMC(dados_para_encoding_treino$Peso, dados_para_encoding_treino$Altura)
...
validacao_engineered$IMC <- IMC(dados_para_encoding_validacao$Peso, dados_para_encoding_validacao$Altura)
...
ggplot(treino_normalizado, aes(x = Peso, y = Calorias)) + geom_point() + geom_smooth()
ggplot(treino_normalizado, aes(x = Altura, y = Calorias)) + geom_point() + geom_smooth()
...
## Mais combinações entre features
...
f16 <- formula(Calorias ~ Batimento.Cardiaco + Temperatura.Corporal + Duracao +
               Idade20_29 + Idade30_39 + Idade40_49 +
               Idade50_59 + Idade60_69 + Idade70_79 +
               Generofeminino + 
               Generomasculino +                     
               (Duracao + Batimento.Cardiaco + Temperatura.Corporal)^3)

f17 <- formula(Calorias ~ Batimento.Cardiaco + Temperatura.Corporal + Duracao +
               Idade20_29 + Idade30_39 + Idade40_49 +
               Idade50_59 + Idade60_69 + Idade70_79 +
               Generofeminino + 
               Generomasculino +                     
               (Duracao + Batimento.Cardiaco + Temperatura.Corporal)^4)
...
f02 <- formula(Calorias ~ Altura + Peso + Duracao + Batimento.Cardiaco + 
                 ...
                 Idade60_69 + Idade70_79 + Generofeminino + Generomasculino)

# Polinomial de grau 3
f03 <- formula(Calorias ~ Altura + Peso + Duracao + Batimento.Cardiaco + 
                 Temperatura.Corporal +
                 I(Altura^2) + I(Peso^2) + I(Duracao^2) + I(Batimento.Cardiaco^2) +
                 I(Temperatura.Corporal^2) +
                 I(Altura^3) + I(Peso^3) + I(Duracao^3) + I(Batimento.Cardiaco^3) +
                 I(Temperatura.Corporal^3) +
                 Idade20_29 + Idade30_39 + Idade40_49 + Idade50_59 +
                 Idade60_69 + Idade70_79 + Generofeminino + Generomasculino)

# Polinomial de grau 4
f04 <- formula(Calorias ~ Altura + Peso + Duracao + Batimento.Cardiaco + 
                 Temperatura.Corporal +
                 I(Altura^2) + I(Peso^2) + I(Duracao^2) + I(Batimento.Cardiaco^2) +
                 I(Temperatura.Corporal^2) +
                 I(Altura^3) + I(Peso^3) + I(Duracao^3) + I(Batimento.Cardiaco^3) +
                 I(Temperatura.Corporal^3) +
                 I(Altura^4) + I(Peso^4) + I(Duracao^4) + I(Batimento.Cardiaco^4) +
                 I(Temperatura.Corporal^4) +
                 Idade20_29 + Idade30_39 + Idade40_49 + Idade50_59 +
                 Idade60_69 + Idade70_79 + Generofeminino + Generomasculino)

# Polinomial de grau 5
f05 <- formula(Calorias ~ Altura + Peso + Duracao + Batimento.Cardiaco + 
                 Temperatura.Corporal +
                 I(Altura^2) + I(Peso^2) + I(Duracao^2) + I(Batimento.Cardiaco^2) +
                 I(Temperatura.Corporal^2) +
                 I(Altura^3) + I(Peso^3) + I(Duracao^3) + I(Batimento.Cardiaco^3) +
                 ...
                 I(Altura^4) + I(Peso^4) + I(Duracao^4) + I(Batimento.Cardiaco^4) +
                 I(Temperatura.Corporal^4) +
                 I(Altura^5) + I(Peso^5) + I(Duracao^5) + I(Batimento.Cardiaco^5) +
                 I(Temperatura.Corporal^5) +
                 Idade20_29 + Idade30_39 + Idade40_49 + Idade50_59 +
                 Idade60_69 + Idade70_79 + Generofeminino + Generomasculino)

# Polinomial de grau 6
f06 <- formula(Calorias ~ Altura + Peso + Duracao + Batimento.Cardiaco + 
                 Temperatura.Corporal +
                 I(Altura^2) + I(Peso^2) + I(Duracao^2) + I(Batimento.Cardiaco^2) +
                 I(Temperatura.Corporal^2) +
                 I(Altura^3) + I(Peso^3) + I(Duracao^3) + I(Batimento.Cardiaco^3) +
                 ...
                 I(Altura^5) + I(Peso^5) + I(Duracao^5) + I(Batimento.Cardiaco^5) +
                 I(Temperatura.Corporal^5) +
                 I(Altura^6) + I(Peso^6) + I(Duracao^6) + I(Batimento.Cardiaco^6) +
                 I(Temperatura.Corporal^6) +
                 Idade20_29 + Idade30_39 + Idade40_49 + Idade50_59 +
                 Idade60_69 + Idade70_79 + Generofeminino + Generomasculino)

# Polinomial de grau 7
f07 <- formula(Calorias ~ Altura + Peso + Duracao + Batimento.Cardiaco + 
                 Temperatura.Corporal +
                 I(Altura^2) + I(Peso^2) + I(Duracao^2) + I(Batimento.Cardiaco^2) +
                 I(Temperatura.Corporal^2) +
                 I(Altura^3) + I(Peso^3) + I(Duracao^3) + I(Batimento.Cardiaco^3) +
                 ...
                 I(Temperatura.Corporal^5) +
                  I(Altura^6) + I(Peso^6) + I(Duracao^6) + I(Batimento.Cardiaco^6) +
                 I(Temperatura.Corporal^6) +
                 I(Altura^7) + I(Peso^7) + I(Duracao^7) + I(Batimento.Cardiaco^7) +
                 I(Temperatura.Corporal^7) +
                 Idade20_29 + Idade30_39 + Idade40_49 + Idade50_59 +
                 Idade60_69 + Idade70_79 + Generofeminino + Generomasculino)

# Polinomial de grau 8
f08 <- formula(Calorias ~ Altura + Peso + Duracao + Batimento.Cardiaco + 
                 Temperatura.Corporal +
                 I(Altura^2) + I(Peso^2) + I(Duracao^2) + I(Batimento.Cardiaco^2) +
                 I(Temperatura.Corporal^2) +
                 I(Altura^3) + I(Peso^3) + I(Duracao^3) + I(Batimento.Cardiaco^3) +
                 ...
                 I(Altura^7) + I(Peso^7) + I(Duracao^7) + I(Batimento.Cardiaco^7) +
                 I(Temperatura.Corporal^7) +
                 I(Altura^8) + I(Peso^8) + I(Duracao^8) + I(Batimento.Cardiaco^8) +
                 I(Temperatura.Corporal^8) +
                 Idade20_29 + Idade30_39 + Idade40_49 + Idade50_59 +
                 Idade60_69 + Idade70_79 + Generofeminino + Generomasculino)
...
p <- p + ggtitle("Curva vies/variancia") + ylab("MAE") + scale_x_discrete(name ="Formula", limits=as.character(1:length(formulas)))
...
head(dados_para_encoding_teste)
```
