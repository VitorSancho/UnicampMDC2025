...
model_metrics <- function(train_set, validation_set, model){
  ...
  results_baseline$MAE <- format(results_baseline$MAE, scientific = FALSE)
  results_baseline$MSE <- format(results_baseline$MSE, scientific = FALSE)
  results_baseline$R2 <- format(results_baseline$R2, scientific = FALSE)
  results_baseline$RMSE <- format(results_baseline$RMSE, scientific = FALSE)
  results_baseline$RAE <- format(results_baseline$RAE, scientific = FALSE)
...
f_pol02 <- getHypothesis(colnames(treino_normalizado)[1:6], colnames(treino_normalizado)[7:14], degree = 2)

# Polinomial de grau 3
f_pol03 <- getHypothesis(colnames(treino_normalizado)[1:6], colnames(treino_normalizado)[7:14], degree = 3)

# Polinomial de grau 4
f_pol04 <- getHypothesis(colnames(treino_normalizado)[1:6], colnames(treino_normalizado)[7:14], degree = 4)

# Polinomial de grau 5
f_pol05 <- getHypothesis(colnames(treino_normalizado)[1:6], colnames(treino_normalizado)[7:14], degree = 5)

# Polinomial de grau 6
f_pol06 <- getHypothesis(colnames(treino_normalizado)[1:6], colnames(treino_normalizado)[7:14], degree = 6)

# Polinomial de grau 7
f_pol07 <- getHypothesis(colnames(treino_normalizado)[1:6], colnames(treino_normalizado)[7:14], degree = 7)

# Polinomial de grau 8
f_pol08 <- getHypothesis(colnames(treino_normalizado)[1:6], colnames(treino_normalizado)[7:14], degree = 8)


# Lista completa de fórmulas
formulas <- c(f_pol02, f_pol03, f_pol04, f_pol05, f_pol06, f_pol07, f_pol08)
